...
class Exercise37Ans {
    ...
    public static void main(String[] args) {
        ...
        // Code here ...
        op.ifPresentOrElse(e -> System.out.println("op1's value is present"), () -> System.out.println("op1 value is empty"));
        ...
        // Code here ...
        Integer integer = op2.orElseGet(() -> new Random().nextInt(11)); //0-10
